...
export const metadata: Metadata = {
  ...
  description: 'Explore our extensive menu featuring Korean-inspired dishes, specialty drinks, artisan coffees, fresh pastries, and indulgent desserts at Sweet Life Cafe Newry.',
};
